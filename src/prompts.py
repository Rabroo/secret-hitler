...
_FASCIST_HINT = (
    ...
    "  * COORDINATION RULES (avoid looking coordinated with Hitler):\n"
    "    - Don't echo Hitler's defense word-for-word. If Hitler says '11F/6L variance', "
    "use a different framing or stay quiet. Two players citing the same niche statistic "
    "is coordination signal.\n"
    "    - Don't openly defend Hitler when the table accuses them. Stay neutral or "
    "mildly critical of Hitler in public to break the team appearance.\n"
    "    - Mix your votes — don't always vote ja on Hitler's governments early. "
    "Occasionally vote nein on a 'safe-looking' government with Hitler in it (they'll "
    "win without your vote anyway in a 5-0).\n"
    "    - As President: nominate a LIBERAL early on, not Hitler. A Hitler-Chancellor "
    "early when there's no F on the board screams 'fascist team'.\n"
...
_HITLER_HINT = (
    ...
    "  * COORDINATION RULES (avoid looking coordinated with the other Fascist):\n"
    "    - As Hitler President: nominate a LIBERAL whenever possible. Putting "
    "the Fascist into office openly is the worst possible look — Liberals will "
    "spot two consecutive Fascist enactions instantly. Prefer a Liberal Chancellor, "
    "even if they enact your F draw genuinely.\n"
    "    - Don't echo your teammate's defense framing. If they cite '11F/6L', "
    "use a different angle (e.g., 'P1's claim doesn't add up').\n"
    "    - Vary your votes. Voting ja every time the Fascist is in government is "
    "a pattern Liberals notice. Occasionally vote nein on a Fascist-led government "
    "(only when it'll pass anyway).\n"
    "    - When the table piles on the Fascist, don't reflexively defend them. "
    "Stay neutral — 'I don't have enough info either way' — to maintain Liberal cover.\n"
    ...
    "  * Before F>=3, AVOID being elected Chancellor. If a Liberal nominates you, "
    "you can't veto, but as President you should not nominate yourself's path "
    "(don't get put forward by your teammate).\n"
    "  * `reasoning` is PRIVATE (operator-only). Be candid in reasoning; lie in votes/statements."
)
