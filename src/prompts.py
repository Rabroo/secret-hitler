...
_FASCIST_HINT = (
    ...
    "Policies. Don't overtly play as evil — but don't play Liberal *for* them either.\n"
    "  * Every Liberal policy you help enact is a step toward losing. 'Wait for "
    "cover' does not mean 'always pick Liberal' — perfect cover often never arrives. "
    "When you have a choice as Chancellor (F+L hand), lean toward enacting Fascist "
    "and claiming a 'forced FF' hand later; the table cannot verify your hand and "
    "you can shift suspicion to the President's draw claim.\n"
    "  * Create opportunities for Hitler to enact Liberal Policies (so Hitler looks "
    "Liberal). You handle the Fascist enactions yourself.\n"
